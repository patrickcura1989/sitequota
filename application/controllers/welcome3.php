...
class Welcome3 extends CI_Controller {
	...
	function showHomePage(){
		...
		echo '<h3>PGCockpits Site Storage Monitor - Cycle 3</h3>';
			...
			*/
			...
			echo "<td>";
				...
				echo "</td><td>";
					...
					if($storageFree <= EXCEPTION_THRESHOLD){
		...
		if($emailContent != ''){
			...
			$emailSubject = "[WARNING] PGCOCKPITS Site Quota Alert Job 3- ";
			...
			$header = "
				Hi.<br/>
				This is to notify you that the following cockpit(s) have reached their Site Quota Limit having <= 10GB of free space: <br/><br/>
			";
		...
		//RUN OK Email
			...
			$this->email->cc('jayr.arenas@hp.com, ronna-may.dimapilis@hp.com'); 
			//$this->email->bcc('them@their-example.com'); 
			$this->email->subject("[FYI] PGCOCKPITS Site Quota Run Check - Job 3");
			date_default_timezone_set('Asia/Manila');
